...
const CreatePost = () => {
  ...
  return (
    <Fragment>
        <div className='create_post_mobile'>
            <div className='post_heading_mobile'>
                <h3>Create Post</h3>
            </div>
            <div className='post_input_mobile'> 
                <h6>Topic</h6>
                <textarea
                    maxLength={40}
                    className='topic-input_mobile'
            ...
            <div className='post_button_mobile'>
