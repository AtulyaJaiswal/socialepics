...
export const USER_SCHEDULED_POSTS_REQUEST = "USER_SCHEDULED_POSTS_REQUEST";
export const USER_SCHEDULED_POSTS_SUCCESS = "USER_SCHEDULED_POSTS_SUCCESS";
export const USER_SCHEDULED_POSTS_FAIL = "USER_SCHEDULED_POSTS_FAIL";
